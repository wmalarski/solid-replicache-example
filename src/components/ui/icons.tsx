...
export const LaughIcon: Component<ComponentProps<"svg">> = (props) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="24"
...
export const MousePointerIcon: Component<ComponentProps<"svg">> = (props) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="24"
			...
			{...props}
		>
			<title>Mouse Pointer Icon</title>
